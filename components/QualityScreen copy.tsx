...
const QualityScreen: React.FC<QualityScreenProps> = ({ setPage, registerNextAction, registerPrevAction }) => {
  ...
  useEffect(() => {
    registerNextAction(() => setCurrentSlide((prev) => (prev + 1) % 6));
  ...
  return (
    <div className="relative w-[1920px] h-full flex-shrink-0 flex items-center overflow-hidden bg-black">
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(/images/bg-2-1.png)',
...
const Slide2: React.FC<Slide2Props> = ({ isActive }) => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: 'url(/images/bg-2-2.png)',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
      }}
    >
...
const Slide3: React.FC<Slide3Props> = ({ isActive }) => {
  ...
  return (
    ...
    >
      ...
      >
        <img src="/images/vehicle1.png" alt="Vehicle 1" className={`relative z-0 ${getVehicleAnim('delay-[800ms]')}`} />
        <img src="/images/vehicle2.png" alt="Vehicle 2" className={`-ml-[10px] relative z-10 ${getVehicleAnim('delay-[1100ms]')}`} />
        <img src="/images/vehicle3.png" alt="Vehicle 3" className={`-ml-[10px] relative z-20 ${getVehicleAnim('delay-[1400ms]')}`} />
        <img src="/images/vehicle4.png" alt="Vehicle 4" className={`-ml-[10px] relative z-30 ${getVehicleAnim('delay-[1700ms]')}`} />
        <img src="/images/vehicle5.png" alt="Vehicle 5" className={`-ml-[10px] relative z-40 ${getVehicleAnim('delay-[2000ms]')}`} />
      </div>
    </div>
  );
};
...
const Slide5: React.FC<Slide5Props> = ({ isActive }) => {
  ...
  return (
    <div
      className="relative w-[1920px] h-full flex-shrink-0"
      style={{
        backgroundImage: 'url(/images/bg-2-5.png)',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
      }}
    >
      ...
      >
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[0]}ms` }}>
          ...
          <g mask="url(#mask0_4484_6143)">
            ...
            <image href="/images/mexico.png" x="98" y="159" width="120" height="120" preserveAspectRatio="xMidYMid slice" />
          </g>
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[1]}ms` }}>
          ...
          <g mask="url(#mask1_4484_6143)">
            ...
            <image href="/images/brazil.png" x="356" y="265" width="120" height="120" preserveAspectRatio="xMidYMid slice" />
          </g>
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[2]}ms` }}>
          ...
          <g mask="url(#mask2_4484_6143)">
            <circle cx="1358" cy="144" r="60" fill="white" />
            <image href="/images/korea.png" x="1298" y="84" width="120" height="120" preserveAspectRatio="xMidYMid slice" />
          </g>
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[3]}ms` }}>
          ...
          <g mask="url(#mask3_4484_6143)">
            ...
            <image href="/images/india.png" x="1057" y="149" width="120" height="120" preserveAspectRatio="xMidYMid slice" />
          </g>
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[4]}ms` }}>
          ...
          <g mask="url(#mask4_4484_6143)">
            ...
            <image href="/images/Kazakhstan.png" x="878" y="52" width="120" height="120" preserveAspectRatio="xMidYMid slice" />
          </g>
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[5]}ms` }}>
          ...
          <g mask="url(#mask5_4484_6143)">
            ...
            <image href="/images/flag-usa.png" x="0" y="213" width="65" height="65" preserveAspectRatio="xMidYMid slice" />
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[6]}ms` }}>
          ...
          <g mask="url(#mask6_4484_6143)">
            ...
            <image href="/images/pin7.png" x="327" y="447" width="65" height="65" preserveAspectRatio="xMidYMid slice" />
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[7]}ms` }}>
          ...
          <g mask="url(#mask7_4484_6143)">
            ...
            <image href="/images/pin8.png" x="425" y="395" width="65" height="65" preserveAspectRatio="xMidYMid slice" />
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[8]}ms` }}>
          ...
          <g mask="url(#mask8_4484_6143)">
            ...
            <image href="/images/pin9.png" x="911" y="311" width="65" height="65" preserveAspectRatio="xMidYMid slice" />
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[9]}ms` }}>
          ...
          <g mask="url(#mask9_4484_6143)">
            ...
            <image href="/images/pin10.png" x="1218" y="285" width="65" height="65" preserveAspectRatio="xMidYMid slice" />
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[10]}ms` }}>
          ...
          <g mask="url(#mask10_4484_6143)">
            ...
            <image href="/images/pin11.png" x="161" y="286" width="65" height="65" preserveAspectRatio="xMidYMid slice" />
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[11]}ms` }}>
          ...
          <g mask="url(#mask11_4484_6143)">
            ...
            <image href="/images/pin12.png" x="755" y="88" width="65" height="65" preserveAspectRatio="xMidYMid slice" />
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[12]}ms` }}>
          ...
          <g mask="url(#mask12_4484_6143)">
            ...
            <image href="/images/pin13.png" x="941" y="181" width="65" height="65" preserveAspectRatio="xMidYMid slice" />
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[13]}ms` }}>
          ...
          <g mask="url(#mask13_4484_6143)">
            ...
            <image href="/images/pin14.png" x="1121" y="278" width="65" height="65" preserveAspectRatio="xMidYMid slice" />
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[14]}ms` }}>
          ...
          <g mask="url(#mask14_4484_6143)">
            ...
            <image href="/images/pin15.png" x="1247" y="197" width="65" height="65" preserveAspectRatio="xMidYMid slice" />
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[15]}ms` }}>
          ...
          <g mask="url(#mask15_4484_6143)">
            ...
            <image href="/images/pin16.png" x="1429" y="403" width="65" height="65" preserveAspectRatio="xMidYMid slice" />
        ...
        <g className={`pin-animate ${isActive ? 'active' : ''}`} style={{ animationDelay: `${pinDelays[16]}ms` }}>
          ...
          <g mask="url(#mask16_4484_6143)">
            ...
            <image href="/images/pin17.png" x="1400" y="213" width="65" height="65" preserveAspectRatio="xMidYMid slice" />
    ...
    <div className="relative w-[1920px] h-full flex-shrink-0 bg-[#F5F9FF] flex flex-col font-['42dot_Sans'] justify-center overflow-hidden">
      ...
      <div className="flex-1 flex items-center w-full min-h-[300px] mt-[100px]">
        ...
        <div className={`flex-shrink-0 relative flex justify-center items-center ${getAnimStyle('delay-[500ms]', 'slideLeft')}`}>
          <img src="/images/product1.png" alt="Digital Cluster" className="block w-[860px] object-contain ml-[100px]" />
          <video
            ref={videoRef}
            src="/images/hino.mp4"
            autoPlay
      ...
      <div className="flex-1 flex items-center w-full justify-end min-h-[300px] -mt-[100px]">
        ...
        <div className={`flex-shrink-0 ${getAnimStyle('delay-[2000ms]', 'slideRight')}`}>
          <img src="/images/product2.png" alt="Dash Cam" className="block w-[409px] object-contain mr-[100px]" />
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center w-full min-h-[300px]">
        ...
        <div className={`flex-shrink-0 relative ${getAnimStyle('delay-[2500ms]', 'slideLeft')}`}>
          <img src="/images/product3.png" alt="Center Display" className="block w-[860px] object-contain ml-[200px] -mt-[100px] " />
          <video
            ref={videoRef2}
            src="/images/worldcup.mp4"
            muted
            playsInline
